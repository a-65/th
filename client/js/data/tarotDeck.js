// ============================================
// data/tarotDeck.js — МАССИВ КАРТ ТАРО
// ============================================

/**
 * tarotDeck — массив всех 78 карт колоды "Таро Гранд Эттейла"
 * Каждая карта содержит:
 *   - id: уникальный идентификатор (0-77)
 *   - name: название карты
 *   - upright: значение в прямом положении
 *   - reversed: значение в перевёрнутом положении
 */
const tarotDeck = [
