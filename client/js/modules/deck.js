 ...
 *
 * Важно:
 * - звук лежит внутри client/sounds, поэтому путь должен быть относительным к index.html;
 * - изображения лежат в ../images относительно client/index.html.
 */
...
/**
 * Возвращает путь к изображению карты по её id.
 * @param {number} cardId
 * @returns {string}
 */
...
/**
 * Возвращает путь к fallback-изображению.
 * @returns {string}
 */
...
/**
 * Создаёт и настраивает объект Audio для звука тасовки.
